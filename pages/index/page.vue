...
import Swiper from "@/layouts/Swiper.vue";
import SwiperSlide from "@/layouts/SwiperSlide.vue";
import { swiperData } from "@/assets/css/dataSource";
import CounterAnimation from '@/layouts/CounterAnimation.vue';
...
const stats = [
  { value: 200, label: 'Estudiantes inscritos', color: 'text-yellow-600', prefix: true },
  { value: 50, label: 'Oportunidades activas', color: 'text-green-600', prefix: true },
  { value: 30, label: 'Organizaciones aliadas', color: 'text-purple-600', prefix: true },
  { value: 80, label: 'Constancias emitidas', color: 'text-pink-600', prefix: true },
  { value: 10, label: 'Carreras representadas', color: 'text-blue-600', prefix: false },
  { value: 100, label: 'Conexiones generadas', color: 'text-indigo-600', prefix: true }
];
  ...
  <NuxtLayout name="landing" full>
    ...
    <template>
      <section class="py-5 px-4 bg-white">
        <div class="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-3 gap-6 text-center">
      ...
      <div class="py-10 container mx-auto px-4">
        <div class="text-center">
          ...
          <p class="mt-4 text-lg text-gray-600">
            Conéctate con iniciativas que reconocen tu talento, brindan experiencia práctica y te preparan para el mundo real.
          </p>
        </div>
        <Swiper :list="swiperData" :index="index" @change="change">
          <template #default="{ item }">
            <div class="relative h-full">
              ...
              <div class="absolute inset-x-0 bottom-0 p-4 bg-[linear-gradient(0deg,rgba(0,0,0,0.8)_0%,transparent_100%)]">
                {{ item.description }}
              </div>
            </div>
          </template>
    ...
    <section class="py-20 px-4 bg-white flex justify-center">
      <div class="max-w-7xl w-full">
        ...
        <div class="mt-16 flex flex-wrap justify-center gap-8">
          <div class="flex flex-col items-center text-center w-full sm:w-[47%] lg:w-[30%]">
            ...
            <p class="text-gray-600 text-sm leading-relaxed">
              Completa tu perfil académico y profesional, agrega tus habilidades y experiencias.
            </p>
          </div>
          ...
          <div class="flex flex-col items-center text-center w-full sm:w-[47%] lg:w-[30%]">
            ...
            <p class="text-gray-600 text-sm leading-relaxed">
              Nuestro algoritmo te conecta con oportunidades que se ajustan a tu perfil y preferencias.
            </p>
          </div>
          ...
          <div class="flex flex-col items-center text-center w-full sm:w-[47%] lg:w-[30%]">
            ...
            <p class="text-gray-600 text-sm leading-relaxed">
              Aplica directamente a las ofertas y comienza tu carrera profesional.
            </p>
          </div>
        </div>
      </div>
